...
export const Projects = () => {
    ...
    const data=[
        ...
        The data is handled with the help of MongoDB .For that I have used MongoDB Cloud `,tech:[faReact,faNodeJs,faJs],git:true,live:false,
        Glink:"https://github.com/iharshgaur/Revv-Clone",Llink:"/works"},
        ...
        para:`Worked My self for 4 hours to complete the game.  I have use react and javascript to bulid the game.
         ...
         minimax npm .`,tech:[faReact,faCss3,faJs],git:true,live:true,Glink:"https://github.com/ManishRaghavan/tic_tac_toe"
        ...
        para:`Worked My self for 2 hours to complete the codepen. I have use react and javascript to bulid the codepen.
          ...
          codemirror and with simple javascript I have implemented the display box .`,tech:[faReact,faCss3,faJs],git:true,live:true
        ...
        use in the premium content. `,tech:[faHtml5,faCss3,faJs],git:true,live:false
